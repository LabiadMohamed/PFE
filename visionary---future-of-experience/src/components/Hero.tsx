...
import manGlasse1 from "../assets/manGlasse1.webp";
import glasses3 from "../assets/glasses3.jpg";

const slides = [
  { id: 1, title: "Visionary", subtitle: "Welcome to the era of spatial computing.",  bgImage: manGlasse1 },
  { id: 2, title: "Immersive", subtitle: "A canvas for your apps that lives in your space.",  bgImage: glasses3 },
