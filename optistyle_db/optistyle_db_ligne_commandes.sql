...
CREATE TABLE `ligne_commandes` (
  `id_ligne_cmd` int NOT NULL AUTO_INCREMENT,
  `prix_unitaire` decimal(10,2) NOT NULL,
  `quantite` int NOT NULL,
  `id_commande` int NOT NULL,
  `id_produit` int NOT NULL,
  PRIMARY KEY (`id_ligne_cmd`),
  KEY `FKq1qj3euk59timrffimdmfmwrr` (`id_commande`),
  KEY `FK41e04vcj02kgvatocfntqdnln` (`id_produit`),
  CONSTRAINT `FK41e04vcj02kgvatocfntqdnln` FOREIGN KEY (`id_produit`) REFERENCES `produits` (`id_produit`),
  CONSTRAINT `FKq1qj3euk59timrffimdmfmwrr` FOREIGN KEY (`id_commande`) REFERENCES `commandes` (`id_commande`)
